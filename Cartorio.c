...
int deletar()
{
	...
	printf("Digite o CPF do usuário a ser deletado: "); //coleta o dado necessário para deletar
	scanf("%s", cpf);	
	...
	{
	fclose(file); // Fecha o arquivo, pois ele é existente
...
int main()
{
	...
	for(laco=1; laco=1;)
	{
		...
		system("cls"); //responsávei por limpar a tela
